                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-white">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[10px] font-black tracking-widest">HRMS-CE</span>
                      </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="text-[7px] text-slate-500 space-y-1 leading-normal list-disc pl-3 font-mono">
                      <li>This credential represents official identity authorization for HRMS-CE physical/digital secure portals.</li>
                  ...
                  <div className="border-t border-slate-900/60 pt-2 text-center text-[7px] text-slate-500 font-mono">
                    If found, return to HRMS-CE Inc, 123 Business Ave, San Francisco, CA.
                  </div>
