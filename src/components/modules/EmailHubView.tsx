...
export default function EmailHubView({
  ...
  const getSenderForCampaign = (type: string) => {
    switch(type) {
      case 'Payslip': return 'HRMS-CE Payroll';
      case 'Work Anniversary': return 'HRMS-CE Leadership';
  ...
  const getTemplatePreview = () => {
    ...
    if (campaignType === 'Birthday') {
      ...
      body = `Hi ${emp.name},\n\nThe entire team at HRMS-CE wishes you an incredible birthday! Thank you for bringing your talent and positive energy to work every day. Have a fantastic day!\n\nWarm regards,\nHR Operations`;
      ...
      body = `Hi ${emp.name},\n\nYour payslip for June 2026 has been successfully generated and compiled. You can review and print it inside your secure HRMS-CE Portal.\n\nBest regards,\nPayroll Team`;
    }
...
Enjoy a complimentary Starbucks voucher on HRMS-CE.
Code: ${code}
----------------------------------------
...
Payroll Team`;
  ...
  const getFormattedHTMLForCampaign = (
    ...
    if (type === "Birthday") {
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td valign="top">
                ...
                <p style="margin: 3px 0 0 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 11px; color: #be185d; line-height: 1.4;">Enjoy a complimentary Starbucks voucher on HRMS-CE.</p>
      ...
      bannerText = "HRMS-CE Secure Payroll";
      accentBlock = `
      ...
      bannerText = "HRMS-CE Team Memorandum";
    }
          ...
          <tr>
            <td style="padding: 24px; text-align: left;">
              ...
              <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #f1f5f9; font-family: sans-serif; font-size: 12px; color: #94a3b8; text-align: center;">
                This secure memorandum is intended solely for employees of HRMS-CE Inc.
              </div>
            </td>
          </tr>
        </table>
  ...
  const copyStyledEmailToClipboard = async () => {
    ...
    try {
      ...
      onTriggerEmailCampaign({
        ...
        recipientEmail: emp.email,
        campaignType,
        subject: getPlainTextTemplateDraft(emp)?.subject || `HRMS-CE Campaign: \${campaignType}`,
        body: plainText,
        status: 'Sent'
      });
      ...
      <div className="w-full max-w-xl mx-auto bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm font-sans transition-all duration-200">
        ...
        {type === 'Birthday' && (
          <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-600 p-5 text-white text-center relative overflow-hidden">
            ...
            <p className="text-[9px] uppercase tracking-widest font-mono font-bold opacity-90">HRMS-CE Celebrates You</p>
        ...
        {type === 'Work Anniversary' && (
          <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-amber-500 p-5 text-white text-center relative overflow-hidden">
            ...
            <p className="text-[9px] uppercase tracking-widest font-mono font-bold opacity-90">HRMS-CE Career Milestone</p>
        ...
        {type === 'Payslip' && (
          <div className="bg-gradient-to-r from-emerald-600 to-teal-700 p-5 text-white text-center relative overflow-hidden">
            ...
            <p className="text-[9px] uppercase tracking-widest font-mono font-bold opacity-90">HRMS-CE Secure Payroll</p>
        ...
        {type === 'General Notice' && (
          <div className="bg-slate-800 dark:bg-slate-900 p-5 text-white text-center relative overflow-hidden border-b border-slate-700">
            ...
            <p className="text-[9px] uppercase tracking-widest font-mono font-bold opacity-90">HRMS-CE Team Memorandum</p>
          ...
          {type === 'Birthday' && (
            <div className="p-3 bg-purple-50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/30 rounded-xl flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-purple-700 dark:text-purple-400">Enjoy a complimentary Starbucks voucher on HRMS-CE.</p>
        ...
        <div className="bg-slate-100 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 px-5 py-3 text-[9px] text-slate-500 text-center space-y-0.5">
          <p className="font-bold text-slate-700 dark:text-slate-400">HRMS-CE Operations & Internal Communications</p>
          <p>This is an automated transactional notification sent directly to your secure staff record.</p>
          <p>© 2026 HRMS-CE Inc. 123 Business Ave, Suite 400, San Francisco, CA.</p>
        </div>
      </div>
    );
  };
