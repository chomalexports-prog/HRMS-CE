...
export default function LandingPage({ onEnterApp, theme, onToggleTheme }: LandingPageProps) {
  ...
  const workflowSteps = [
    { title: "Candidate Applies", desc: "Resume automatically parsed and analyzed by HRMS-CE AI." },
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        ...
        <div id="bento-features" className="my-24">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-slate-700 dark:text-slate-300 text-xs sm:text-sm mt-3 max-w-xl mx-auto font-medium">HRMS-CE integrates the full spectrum of modern HR tools into a single workflow-driven framework. Skip tab-switching and fragmented folders.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 flex flex-col justify-center">
              ...
              <p className="text-slate-700 dark:text-slate-300 text-xs mt-3 leading-relaxed font-medium">
                Say goodbye to chasing email threads and physical signatures. Choose triggers, set target approval policies, and let HRMS-CE coordinate the execution background logs autonomously.
              </p>
            ...
            <div className="lg:col-span-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-6 flex flex-col justify-between min-h-[260px] relative overflow-hidden transition-colors">
              <div className="flex justify-between items-center pb-4 border-b border-slate-200 dark:border-slate-800">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-bold text-slate-900 dark:text-white">HRMS-CE AI Workflow Hub</span>
                </div>
